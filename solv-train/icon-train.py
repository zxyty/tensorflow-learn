...
icons_dir_path = "D:/code/python/tensorflow/tensorflow-learn/solv-train/icons"
...
# 未加形变的图像处理
history = model.fit(x_train, y_train, batch_size=32, epochs=20, validation_split=0.3, validation_freq=2, callbacks=[cp_callback])
model.summary()
